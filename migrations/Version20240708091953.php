 ...
 */
final class Version20240708091953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64983FA6DD0 FOREIGN KEY (commercant_id) REFERENCES commercants (id)');
